...
(function(){
    (function(e, t, n){
        ...
        r.prototype.init = function(){
            var n, c, r, i, s, o, u, a = this;
            n = e(this.element);
            c = n.children('.controls');
            if (!c.size()) c = n;
            this.data = e.data(this);
            e.data(this, "animating", !1);
            e.data(this, "total", n.children().not(".controls", n).length);
            ...
            n.slidesContainer = n.children().not(".controls", n).wrapAll("<div class='slidesjs-container'>", n).parent().css({overflow: "hidden", position: "relative"});
            ...
            e(".slidesjs-previous", c).click(function(e){
                e.preventDefault();
                a.stop(!0);
                return a.previous(a.options.navigation.effect)
            });
            if (this.options.play.active){
                s = e("<a>", {"class": "slidesjs-play slidesjs-navigation", href: "#", title: "Play", text: "Play"}).appendTo(c);
                u = e("<a>", {"class": "slidesjs-stop slidesjs-navigation", href: "#", title: "Stop", text: "Stop"}).appendTo(c);
                s.click(function(e){
                    e.preventDefault();
                    return a.play(!0)
                });
            ...
            if (this.options.pagination.active){
                i = e("<ul>", {"class": "slidesjs-pagination"}).appendTo(c);
        ...
        r.prototype.update = function(){
            ...
            r = t.width();
            var mh = this.options.height;
            e(".slidesjs-control", t).children().each(function(i, item){
                if ($(item).height() < mh) mh = $(item).height();
            });
            //n = this.options.height / this.options.width * r;
            this.options.width = r;
            this.options.height = mh;
            return e(".slidesjs-control, .slidesjs-container", t).css({width: r, height: mh})
        };
