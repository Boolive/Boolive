...
<div class="Item Field ImageField<?=$class?>" data-v="<?=$v['view_uri']?>" data-o="<?=$v['uri']?>" data-l="<?=$v['link']?>" data-nl="<?=$v['newlink']?>" data-p="ImageField">
    ...
    <div class="inpt">
        ...
        <div class="Item__select Field__select ImageField__select"><img width="16" height="16" src="/site/library/admin/widgets/BaseExplorer/views/Item/res/style/img/touch.png" alt=""/></div>
    </div>
