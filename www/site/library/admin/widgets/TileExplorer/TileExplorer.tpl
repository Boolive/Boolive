<div class="BaseExplorer" data-o="<?=$v['object']?>"  data-v="<?php echo $v['view_uri'];?>" data-p="BaseExplorer">
    <div class="BaseExplorer__head TileExplorer__head">
        <div class="BaseExplorer__head-left">
            ...
            <?php endif;?>
            <div class="BaseExplorer__attribs-btn" title="Изменить адрес (URI) объекта"><img src="/site/library/admin/widgets/BaseExplorer/res/base_style/uri-link.png" width="16" height="16" alt=""/></div>
        </div>
