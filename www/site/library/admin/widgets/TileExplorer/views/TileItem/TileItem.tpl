...
?><div class="Item TileItem <?=$class?>" data-v="<?=$v['view_uri']?>" data-o="<?=$v['uri']?>" data-l="<?=$v['link']?>" data-nl="<?=$v['newlink']?>" data-p="Item">
    ...
    <div class="Item__select TileItem__select"><img width="16" height="16" src="/site/library/admin/widgets/BaseExplorer/views/Item/res/style/img/touch.png" alt=""/></div>
    <a class="Item__link TileItem__link" title="Структура ссылки" href="<?=$url?>"><img src="/site/library/admin/widgets/BaseExplorer/views/Item/res/style/img/enter.png" width="16" height="16" alt=""/></a>
