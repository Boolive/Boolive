<div class="BreadcrumbsMenu" data-v="<?php echo $v['view_uri'];?>" data-p="BreadcrumbsMenu">
	<div class="BreadcrumbsMenu__view">
        ...
        <div class="BreadcrumbsMenu__btn BreadcrumbsMenu__btn-inline"><img width="16" height="16" alt="" src="/Site/library/layouts/Admin/BreadcrumbsMenu/res/style/img/pencil.png"/></div>
<!--        <div class="BreadcrumbsMenu__btn BreadcrumbsMenu__btn-editor"><img width="16" height="16" alt="" src="/Site/library/layouts/Admin/BreadcrumbsMenu/res/style/img/pencil.png"/></div>-->
        <a href="/<?=ltrim($v['current']->url(),'/')?>" target="_blank" class="BreadcrumbsMenu__btn BreadcrumbsMenu__btn-out"><img width="16" height="16" alt="" src="/Site/library/layouts/Admin/BreadcrumbsMenu/res/style/img/arrow-out.png"/></a>
	</div>
