ace.define("ace/theme/boolive", ["require", "exports", "module", "ace/lib/dom"], function (e, t, n) {
    t.isDark = !1, t.cssClass = "ace-boolive", t.cssText = '' +
        ...
        '.ace-boolive .ace_gutter {background: #F7F7F7; color: #AAA; border-right: 1px dotted #ccc;}' +
...
//        '.ace-boolive .ace_variable.ace_instance {color: teal;}' +
        ...
        '.ace-boolive .ace_marker-layer .ace_active-line {background: #FFFFCC;}' +
        ...
        '.ace-boolive .ace_gutter-active-line {background-color : rgba(255,255,204,0.5);}' +
