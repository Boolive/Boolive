<div class="Attribs" data-view_uri="<?php echo $v['view_uri'];?>">
    ...
    <form action="" enctype="multipart/form-data" type="POST">
        ...
        <div class="item">
            ...
            <div class="item-col2 item-name">
                <span class="name" data-name="name"></span><span data-name="uri" class="more_value"></span>
        ...
        <div class="item">
            ...
            <div class="item-col2 item-proto">
                <a class="select" href="proto" data-name="proto-show"></a><a href="" data-name="proto-uri" class="more_value"></a>
        ...
        <div class="item">
            ...
            <div class="item-col2  item-value">
                <div class="value">
                    ...
                    <div class="tags">
                        ...
                        <div class="tag default" data-name="is_null">Наследует</div>
        ...
        <div class="item">
            ...
            <div class="item-col2 item-lang">
                <a class="select" href="lang" data-name="lang-show"></a>
        ...
        <div class="item">
            ...
            <div class="item-col2 item-owner">
                <a class="select" href="owner" data-name="owner-show"></a>
        ...
        <div class="item">
            ...
            <div class="item-col2 item-order">
                <input class="attrib order" type="text" id="order" name="attrib[order]" data-name="order" value=""/>
                <span class="error-message"></span>
            </div>
        </div>
        <div class="item">
            ...
            <div class="item-col2 item-is_logic">
        ...
        <div class="item">
            ...
            <div class="item-col2 item-is_hidden">
        ...
        <div class="item">
            ...
            <div class="item-col2 item-is_link">
        ...
        <div class="item">
            ...
            <div class="item-col2 item-overide">
        ...
        <div class="item">
            ...
            <div class="item-col2">
                <a class="reset hide">Отмена</a>
                <a class="submit disable" href="#5">Сохранено</a>
