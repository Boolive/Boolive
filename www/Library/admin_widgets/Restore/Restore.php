    ...
    public function getInputRule()
    {
        return Rule::arrays(array(
                'REQUEST' => Rule::arrays(array(
                        'object' => Rule::any(
                            Rule::arrays(Rule::entity(array('attr','isDelete','=',1))),
                            Rule::entity(array('attr','isDelete','=',1))
                        )->required(),
    ...
    public function work($v = array())
        {
            ...
            // Отображение
                ...
                if (count($objects)>1){
                    $v['message'] = 'Восстановление объектов может изменить работу системы';
                }else{
                    $v['message'] = 'Восстановление объекта может изменить работу системы';
                }
                $v['prev'] = '';
