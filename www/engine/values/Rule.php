 ...
 *   добавляемого фильтра. Обратите внимание, что вызывается не фильтрующий метод, а только добавляется инструкция,
 *   что фильтр с данным именем и аргументами нужно будет применить. В классе Rule используются магические методы,
 *   поэтому можно создавать любые даже не сущесвующие фильтры, если есть в этом смысл.
