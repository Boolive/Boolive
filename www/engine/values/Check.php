 ...
 *
 * - Используются классом \Engine\Values в соответствии с правилами \Boolive\values\Rule для непосредственной
...
class Check{
	 ...
	 * @param null|Error &$error Возвращаемый объект исключения, если значение не соответсвует типу
	 * @param \Boolive\values\Rule $rule Объект правила. Аргументы одноименного фильтра применяются в методе
	 * @return \Boolive\values\Values Любое значение превразается в объект \Engine\Values
	 */
