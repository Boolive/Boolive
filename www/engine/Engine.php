...
class Engine
{
    ...
    {
        // Любой класс может выполнить завершающие действия при звершении работы
        // системы, обработав событие STOP
        Events::Send('STOP');
    }
    ...
    static function SystemRequirements()
    {
        ...
        if (function_exists('apache_get_modules') && !in_array('mod_rewrite',
            apache_get_modules())
        ) {
