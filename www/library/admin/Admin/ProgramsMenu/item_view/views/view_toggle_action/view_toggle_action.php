 ...
 * @version 1.0
 */
namespace site\library\admin\Admin\ProgramsMenu\item_view\views\view_toggle_action;
    ...
    function startRule()
    {
        return Rule::arrays(array(
            'REQUEST' => Rule::arrays(array(
                'program' => Rule::entity(array('is', '/library/admin/widgets/ToggleAction'))->required(), // Объект для пункта меню
