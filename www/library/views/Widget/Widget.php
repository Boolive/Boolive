...
class Widget extends View
{
    ...
    {
//        if (!$this->isLink()){
//            $this->find(array('select'=>'children', 'struct; => 'tree', 'depth'=>array(1,'max'), 'return'=>false, 'comment' => 'read tree of widgets', 'order' => array('order', 'asc')), false);
//        }
    }
    ...
    {
        if ($this->object->isExist() && !$this->object->isDraft()){
