...
--
-- Хост: 127.0.0.1
-- Время создания: Дек 27 2012 г., 11:52
...
('/Contents/main/text/Paragraph', '', 0, 1350470502, 4, 7, '/Library/content_samples/Paragraph', '111', 0, 0, 0, 0, 0, 0, 0),
...
('/Library/admin_widgets/Programs', '', 0, 0, 3, 7, '/Library/views/AutoWidget', 'Programs.tpl', 1, 1, 0, 0, 0, 0, 0),
('/Library/admin_widgets/Programs/description', '', 0, 0, 4, 2, '/Library/views/AutoWidget/description', 'Программами являются обозреватели и редакторы объектов. Выбираются автоматически по настройкам ассоциации на объекты', 0, 0, 0, 0, 0, 0, 0),
...
('/Library/admin_widgets/SelectObject/description', '', 0, 0, 4, 2, '/Library/views/Widget/description', 'Представляет собой обозреватель объектов с функцией выбора объекта', 0, 0, 0, 0, 0, 0, 0),
('/Library/admin_widgets/SelectObject/programs', '', 0, 0, 4, 5, '/Library/admin_widgets/Programs', NULL, 0, 0, 0, 0, 0, 0, 0),
('/Library/admin_widgets/SelectObject/res/jquery.ui.SelectObject', '', 0, 0, 5, 2, '/Library/javascript_plugins/jQueryAjaxWidget', 'jquery.ui.SelectObject.js', 0, 1, 0, 0, 0, 0, 0),
('/Library/admin_widgets/SelectObject/res/style', '', 0, 0, 5, 1, '/Library/views/Css', 'style.css', 0, 1, 0, 0, 0, 0, 0),
('/Library/admin_widgets/SelectObject/submit_title', '', 0, 0, 4, 4, NULL, 'Выбрать', 0, 0, 0, 0, 0, 0, 0),
('/Library/admin_widgets/SelectObject/title', '', 0, 0, 4, 1, '/Library/views/Widget/title', 'Виджет выбора объекта', 0, 0, 0, 0, 0, 0, 0),
...
('/Library/basic/members/User/title', '', 0, 0, 5, 1, '/Library/basic/members/Member/title', 'Пользователь', 0, 0, 0, 0, 0, 0, 0),
...
('/Library/content_widgets/KeywordsCloud', '', 0, 0, 3, 1, '/Library/views/Widget/Widget', 'KeywordsCloud.tpl', 1, 1, 0, 0, 0, 0, 0),
('/Library/content_widgets/KeywordsCloud/object', '', 0, 0, 4, 1, '/Keywords', '', 0, 0, 0, 0, 0, 1, 0),
('/Library/content_widgets/KeywordsCloud/res', '', 0, 0, 4, 1, '/Library/views/Widget/res', NULL, 0, 0, 0, 0, 0, 0, 0),
('/Library/content_widgets/KeywordsCloud/res/style', '', 0, 0, 5, 1, '/Library/views/Css', 'style.css', 0, 1, 0, 0, 0, 0, 0),
...
('/Library/content_widgets/Page/NextPrevNavigation', '', 0, 0, 4, 1, '/Library/views/NextPrevNavigation', NULL, 0, 0, 0, 0, 0, 0, 0),
...
('/Library/javascript_plugins/jQueryAjaxWidget/depends/jquery.autoload', '', 0, 0, 5, 6, '/Library/javascript_plugins/jquery.autobind', NULL, 0, 0, 0, 0, 0, 0, 0),
('/Library/javascript_plugins/jQueryAjaxWidget/depends/jquery.include', '', 0, 0, 5, 4, '/Library/javascript_plugins/jquery.include', NULL, 0, 0, 0, 0, 0, 0, 0),
('/Library/javascript_plugins/jQueryAjaxWidget/depends/jquery.ui.AjaxWidget', '', 0, 0, 5, 5, '/Library/views/JavaScript', 'jquery.ui.AjaxWidget.js', 0, 1, 0, 0, 0, 0, 0),
...
('/Library/javascript_plugins/jquery.autobind', '', 0, 0, 3, 8, '/Library/views/jQueryScript', 'jquery.autobind.js', 0, 1, 0, 0, 0, 0, 0),
('/Library/javascript_plugins/jquery.autobind/description', '', 0, 0, 4, 2, '/Library/views/jQueryScript/description', 'Автоматически подключает плагины jquery к тегам с атрибутом data-plugin. Имя плагина берется из атрибута data-plugin', 0, 0, 0, 0, 0, 0, 0),
('/Library/javascript_plugins/jquery.autobind/title', '', 0, 0, 4, 1, '/Library/views/jQueryScript/title', 'Автоподключение jquery плагинов', 0, 0, 0, 0, 0, 0, 0),
...
('/Library/layouts/Admin/BreadcrumbsMenu', '', 0, 0, 4, 7, '/Library/views/Widget', 'BreadcrumbsMenu.tpl', 1, 1, 0, 0, 0, 0, 0),
...
('/Library/layouts/Admin/Programs', '', 0, 0, 4, 5, '/Library/admin_widgets/Programs', NULL, 0, 0, 0, 0, 0, 0, 0),
('/Library/layouts/Admin/ProgramsMenu', '', 0, 0, 4, 6, '/Library/views/Widget', 'ProgramsMenu.tpl', 1, 1, 0, 0, 0, 0, 0),
...
('/Library/layouts/Admin/res/theme', '', 0, 0, 5, 2, '/Library/views/Css', 'theme.css', 0, 1, 0, 0, 0, 0, 0),
('/Library/layouts/Admin/title', '', 0, 1349409890, 4, 1, '/Library/views/Focuser/title', 'Макет админки', 0, 0, 0, 0, 1, 0, 0),
...
('/Library/layouts/boolive/head/logo', '', 0, 0, 5, 2, '/Library/views/Logo', NULL, 0, 0, 0, 0, 0, 0, 0),
('/Library/layouts/boolive/head/title', '', 0, 1349410160, 5, 1, '/Library/views/ViewGroup/title', 'Шапка', 0, 0, 0, 0, 0, 0, 0),
...
('/Library/layouts/boolive/sidebar/KeywordsCloud', '', 0, 0, 5, 3, '/Library/content_widgets/KeywordsCloud', NULL, 0, 0, 0, 0, 0, 0, 0),
('/Library/layouts/boolive/sidebar/menu', '', 0, 0, 5, 2, '/Library/views/Menu', NULL, 0, 0, 0, 0, 0, 0, 0),
...
('/Library/layouts/boolive/sidebar/title', '', 0, 1349410042, 5, 1, '/Library/views/ViewGroup/title', 'Боковая панель', 0, 0, 0, 0, 0, 0, 0),
('/Library/layouts/boolive/title', '', 0, 0, 4, 1, '/Library/views/Focuser/title', 'Макет Boolive!', 0, 0, 0, 0, 1, 0, 0),
('/Library/layouts/boolive/top', '', 0, 0, 4, 1, '/Library/views/ViewGroup', NULL, 0, 0, 0, 0, 0, 0, 0),
('/Library/layouts/boolive/top/menu', '', 0, 0, 5, 2, '/Library/views/Menu', 'menu.tpl', 0, 1, 0, 0, 0, 0, 0),
...
('/Library/layouts/boolive/top/title', '', 0, 1349410089, 5, 1, '/Library/views/ViewGroup/title', 'Вверх', 0, 0, 0, 0, 0, 0, 0),
...
('/Library/views/Html/body/title', '', 0, 0, 5, 1, '/Library/views/ViewGroup/title', 'Основная область вставки', 0, 0, 0, 0, 1, 0, 0),
('/Library/views/Html/description', '', 0, 0, 4, 2, '/Library/views/Widget/description', 'Определяет заголовки HTML документа, подключая необходимые теги в <HEAD>, требуемые виджетами', 0, 0, 0, 0, 1, 0, 0),
('/Library/views/Html/title', '', 0, 0, 4, 1, '/Library/views/Widget/title', 'HTML разметка', 0, 0, 0, 0, 1, 0, 0),
...
('/Library/views/View/description', '', 0, 0, 4, 2, NULL, 'Базовый объект для создания элементов интерфейса', 0, 0, 0, 0, 1, 0, 0),
('/Library/views/View/title', '', 0, 0, 4, 1, NULL, 'Вид', 0, 0, 0, 0, 1, 0, 0),
('/Library/views/ViewGroup', '', 0, 0, 3, 2, '/Library/views/View', NULL, 1, 0, 0, 0, 0, 0, 0),
('/Library/views/ViewGroup/description', '', 0, 0, 4, 2, '/Library/views/View/description', 'Автоматичеки исполненяет и отображает все подчиенные объекты', 0, 0, 0, 0, 1, 0, 0),
('/Library/views/ViewGroup/title', '', 0, 0, 4, 1, '/Library/views/View/title', 'Группа видов', 0, 0, 0, 0, 1, 0, 0),
('/Library/views/Widget', '', 0, 0, 3, 6, '/Library/views/View', NULL, 1, 0, 0, 0, 0, 0, 0),
('/Library/views/Widget/description', '', 0, 0, 4, 2, '/Library/views/View/description', 'Формирует результат работы спомощью шаблонизации. Шаблоном является значение виджета', 0, 0, 0, 0, 1, 0, 0),
...
('/Members/registered/admins/vova/visit_time', '', 0, 1353558493, 5, 5, '/Library/basic/members/User/visit_time', '1356606216', 0, 0, 0, 0, 0, 0, 0),
